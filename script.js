...
const translations = {
  ...
  hi: {
    ...
    price_fresh_cow_milk: "₹60 / लीटर",
    product_homemade_butter: "घर का बना मक्खन",
    price_homemade_butter: "₹100 / 200ग्राम",
    product_organic_tomatoes: "जैविक टमाटर",
    price_organic_tomatoes: "₹30 / किलो",
    product_fresh_spinach: "ताजा पालक",
    price_fresh_spinach: "₹20 / गुच्छा",
    product_cheddar_cheese: "चेडर चीज़",
    price_cheddar_cheese: "₹120 / 250ग्राम",
    product_organic_carrots: "जैविक गाजर",
    price_organic_carrots: "₹30 / किलो",
    product_fresh_milk: "ताजा दूध",
    price_fresh_milk: "₹60 / लीटर",
    product_natural_curd: "प्राकृतिक दही",
    price_natural_curd: "₹70 / 500ग्राम",
    product_spring_onions: "हरे प्याज",
    price_spring_onions: "₹60 / किलो",
    product_organic_potatoes: "जैविक आलू",
    price_organic_potatoes: "₹50 / किलो",
    product_red_onions: "लाल प्याज",
    price_red_onions: "₹70 / किलो",
    product_green_cucumbers: "हरे खीरे",
    price_green_cucumbers: "₹60 / टुकड़ा",
    product_fresh_cucumbers: "ताजा खीरे",
    price_fresh_cucumbers: "₹60 / टुकड़ा",
    product_apples: "सेब",
    price_apples: "₹100 / किलो",
    product_sweet_mangoes: "मीठे आम",
    price_sweet_mangoes: "₹100 / किलो",
    product_ripe_bananas: "पके केले",
    price_ripe_bananas: "₹70 / दर्जन",
    product_juicy_grapes: "रसीले अंगूर",
    price_juicy_grapes: "₹90 / किलो",
    product_grapes: "अंगूर",
    price_grapes: "₹100 / किलो",
